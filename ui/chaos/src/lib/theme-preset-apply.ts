import { defaultDarkThemeStyles, defaultLightThemeStyles } from "@/lib/theme-preset-defaults";
...
export function getMergedStylesForPreset(presetId: string): MergedThemeStyles | null {
