...
export const hr = {
  ...
  playgrounds: {
    "/playgrounds/break-it/": {
      ...
      tag: "Kaos",
      summary: "Četiri živa servisa, jedan cilj i zajednički proračun kvarova kojim ih pokušavaš srušiti.",
      specs: ["Živi promet", "WebSocket, SSE, polling", "Sam se oporavlja"],
    },
    "/playgrounds/tuner/": {
      ...
      tag: "Zvuk",
      summary: "Prepozna žicu koju trzneš i koliko je raštimana, do centa.",
      specs: ["Mikrofon", "5 štimova", "Sve u pregledniku"],
    },
    "/playgrounds/fretboard/": {
      ...
      tag: "Zvuk",
      summary: "Zada notu, čuje jesi li je odsvirao i pamti one koje promašuješ.",
      specs: ["Mikrofon", "Nizovi", "Sve u pregledniku"],
    },
    "/playgrounds/spectrogram/": {
      ...
      tag: "Zvuk",
      summary: "Spektrogram uživo svega što mikrofon čuje, s visinom tona imenovanom u hodu.",
      specs: ["Mikrofon", "Uživo", "Sve u pregledniku"],
    },
    "/playgrounds/chords/": {
      ...
      tag: "Teorija",
      summary: "Imenuje akord pod tvojim prstima ili pokaže sve oblike akorda koji upišeš.",
      specs: ["Bez mikrofona", "Oblici za sviranje"],
    },
    "/playgrounds/metronome/": {
      ...
      tag: "Zvuk",
      summary: "Klik koji nikad ne odluta, s tap tempom, podjelama i privatnim dnevnikom vježbanja.",
      specs: ["Zvučni sat", "Tap tempo", "Lokalni dnevnik"],
    },
    "/playgrounds/ear/": {
      ...
      tag: "Teorija",
      summary: "Čuj interval ili akord i imenuj ga; oni koji te prevare vraćaju se.",
      specs: ["Intervali", "Akordi", "Prilagodljivo"],
    },
  } as Record<string, { name?: string; what?: string; tag?: string; summary?: string; specs?: string[] }>,
  principles: [
    {
