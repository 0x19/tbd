// The playgrounds index. Keys are `playgrounds.<slug>`.
...
export const en: Dict = {
  ...
  "playgrounds.live": "Live",
  "playgrounds.cat.label": "Categories",
  "playgrounds.cat.all": "All",
  "playgrounds.cat.systems": "Systems",
  "playgrounds.cat.music": "Music",
  "playgrounds.featured": "Featured",
...
export const hr: Dict = {
  ...
  "playgrounds.live": "Pokrenuto",
  "playgrounds.cat.label": "Kategorije",
  "playgrounds.cat.all": "Sve",
  "playgrounds.cat.systems": "Sustavi",
  "playgrounds.cat.music": "Glazba",
  "playgrounds.featured": "Izdvojeno",
