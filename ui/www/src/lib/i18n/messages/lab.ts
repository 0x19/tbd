...
export const en: Dict = {
  ...
  "wb.live.sandbox": "sandbox",
  "wb.live.runs": "runs / min",
  "wb.live.run_time": "a run p50 / p99",
  "wb.live.unavailable": "missed / min",
  "wb.live.sandbox_down": "The runner is not answering; code cannot run right now.",
  ...
  "wb.cmd.page": "tell the agent which page is being read: /page /lab/rfc/…; alone, forget it",
  "wb.cmd.name": "name this session: /name <title>; alone, rename it in place",
  ...
  "wb.rename": "rename",
  "wb.rename.hint": "double-click to rename",
  "wb.page.label": "the page it is told you are reading",
  "wb.page.placeholder": "none: a path like /lab/",
  "wb.page.none": "no page",
  "wb.agents": "Agents",
  "wb.agents.none": "The agents are not answering.",
  "wb.agents.use": "use in this session",
  "wb.agents.start": "new session",
  "wb.agents.leave": "back to the model",
  "wb.agents.not_yours": "Not available to your role.",
  "wb.agent": "agent",
...
export const hr: Dict = {
  ...
  "wb.live.sandbox": "sandbox",
  "wb.live.runs": "pokretanja / min",
  "wb.live.run_time": "pokretanje p50 / p99",
  "wb.live.unavailable": "propušteno / min",
  "wb.live.sandbox_down": "Runner ne odgovara; kod se trenutno ne može pokrenuti.",
  ...
  "wb.cmd.page": "reci agentu koju stranicu čitaš: /page /lab/rfc/…; samo, zaboravi je",
  "wb.cmd.name": "imenuj ovu sesiju: /name <naslov>; samo, preimenuj je na mjestu",
  ...
  "wb.rename": "preimenuj",
  "wb.rename.hint": "dvoklik za preimenovanje",
  "wb.page.label": "stranica koju agent misli da čitaš",
  "wb.page.placeholder": "nijedna: putanja poput /lab/",
  "wb.page.none": "bez stranice",
  "wb.agents": "Agenti",
  "wb.agents.none": "Agenti ne odgovaraju.",
  "wb.agents.use": "koristi u ovoj sesiji",
  "wb.agents.start": "nova sesija",
  "wb.agents.leave": "natrag na model",
  "wb.agents.not_yours": "Nije dostupno tvojoj ulozi.",
  "wb.agent": "agent",
