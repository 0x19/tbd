...
export const hr: Dict = {
  ...
  "wb.sends":
    "Ono što pošalješ ide servisu modela na ovoj domeni kao tvoj račun, preko prijenosa koji si odabrao, s razinom i prekidačem razmišljanja, i s ranijim potezima ove sesije da bi bio razgovor. Servis bilježi tko je pitao, koja su razina i model odgovorili, tokene i kako je završilo, radi tvog dnevnog proračuna; ne pohranjuje ni pitanje ni odgovor.",
  "wb.intro":
