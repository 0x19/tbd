// The chrome: header, footer, the notice, the 404. Keys are `common.<slug>`.
...
export const en: Dict = {
  ...
  "common.404.back": "Back to the start",
  "common.figures_by": "Figures published by {name}",
};
...
export const hr: Dict = {
  ...
  "common.sign_in": "Prijava",
  "common.sign_out": "Odjava",
  "common.account": "Račun",
  "common.legal": "Pravno",
  "common.terms": "Uvjeti",
  "common.pages": "Stranice",
  "common.elsewhere": "Drugdje",
  "common.toggle_theme": "Promijeni temu",
  "common.theme.light": "Svijetla",
  "common.theme.dark": "Tamna",
  "common.theme.system": "Sustav",
  ...
  "common.404.back": "Natrag na početak",
  "common.figures_by": "Brojke koje objavljuje {name}",
};
