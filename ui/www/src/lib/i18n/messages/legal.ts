// The legal page: the imprint and privacy. Keys are `legal.<slug>`.
import type { Dict } from "./index";

export const en: Dict = {
  "legal.eyebrow": "Legal",
  "legal.title": "Who you are dealing with.",
  "legal.company": "Company details",
  "legal.rows.name": "Legal name",
  "legal.rows.person": "Represented by",
  "legal.rows.founded": "Founded",
  "legal.rows.address": "Registered address",
  "legal.rows.oib": "OIB",
  "legal.rows.mbs": "Court register (MBS)",
  ...
  "legal.p4a":
    "A playground may need to process what you type into it to answer you. Where one does, it says so on its own page, and the rule is the same: nothing is kept that does not have to be. The",
  "legal.p4.terms": "terms",
  "legal.p4b": "cover what you can expect from them.",
};

export const hr: Dict = {
  "legal.eyebrow": "Pravno",
  "legal.title": "S kim imate posla.",
  "legal.company": "Podaci o tvrtki",
  "legal.rows.name": "Tvrtka",
  "legal.rows.person": "Zastupa",
  "legal.rows.founded": "Osnovana",
  "legal.rows.address": "Sjedište",
  "legal.rows.oib": "OIB",
  "legal.rows.mbs": "Sudski registar (MBS)",
  ...
  "legal.p4a":
    "Igralište će možda morati obraditi ono što u njega upišete da bi vam odgovorilo. Gdje je tako, piše na njegovoj stranici, a pravilo je isto: ne čuva se ništa što ne mora. Što od njih možete očekivati piše u",
  "legal.p4.terms": "uvjetima",
  "legal.p4b": "korištenja, koji vrijede za cijelu stranicu.",
};
