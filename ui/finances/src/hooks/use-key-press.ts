  ...
  useEffect(() => {
    const handler = (event: KeyboardEvent) => {
      ...
      if (modifiers) {
        ...
        const metaKeyMatch =
          modifiers.metaKey === undefined || (modifiers.metaKey && (event.metaKey || event.ctrlKey));

        // ctrlKey: true means specifically Ctrl key
        const ctrlKeyMatch = modifiers.ctrlKey === undefined || event.ctrlKey === modifiers.ctrlKey;

        const shiftKeyMatch = modifiers.shiftKey === undefined || event.shiftKey === modifiers.shiftKey;

        const altKeyMatch = modifiers.altKey === undefined || event.altKey === modifiers.altKey;
