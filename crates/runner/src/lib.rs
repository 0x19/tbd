//! The runner service: a gRPC server.
//!
...
use tbd_proto::runner::v1::runner_service_server::RunnerServiceServer;
...
pub async fn serve_with(
    ...
    health_reporter
        .set_serving::<RunnerServiceServer<Runner>>()
        .await;

    let reflection = tonic_reflection::server::Builder::configure()
        .register_encoded_file_descriptor_set(tbd_proto::runner::v1::DESCRIPTOR_SET)
